        ...
        stage('Debug SSH') {
         ...
         stage('push repo to remote host') {
            steps {
                ...
                sh ' ssh -i "/var/lib/jenkins/key1.pem" -o StrictHostKeyChecking=no ec2-user@16.171.197.73 sudo git -C /var/www/html pull https://github.com/z3r0tru5t/DevOps.git'
            }
        }
